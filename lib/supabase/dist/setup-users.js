...
function setupUsersTable() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, config_1.supabase.rpc('create_users_table')];
                case 1:
...
function registerUser(email, username, password, role) {
    return __awaiter(this, void 0, void 0, function () {
        var hashedPassword, insertError;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.hash(password, 10)];
                case 1:
                    hashedPassword = _a.sent();
                    return [4 /*yield*/, config_1.supabase
                            .from('users')
                            .insert([{ email: email, username: username, password: hashedPassword, role: role }])];
                case 2:
